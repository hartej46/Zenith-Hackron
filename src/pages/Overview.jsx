...
function Overview() {
    ...
    const getBarColor = (status) => {
        switch (status) {
            ...
            default:
                return 'var(--color-primary)' // Matches the Solid Black minimalist theme
        }
    }
    ...
    return (
        <div className="dashboard animate-fadeIn">
                ...
                <div className="header-content">
                    <div className="header-left">
                        ...
                        <div className="flex items-center gap-md">
                            ...
                            <span className="badge-minimal bg-black text-white px-sm py-xs rounded text-[10px] font-bold uppercase">AI Powered</span>
                        </div>
                    </div>
            ...
            <div className="stats-grid grid grid-cols-4">
                <div
                    className="stat-card card hover-lift cursor-pointer"
                ...
                >
                    ...
                    <div className="stat-content">
                        ...
                        <div className="stat-footer text-xs text-tertiary mt-xs">
                            <TrendingUp size={12} className="inline mr-xs" /> View Inventory
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="stat-content">
                        ...
                        <div className="stat-footer text-xs text-tertiary mt-xs">Check urgent alerts</div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="stat-content">
                        ...
                        <div className="stat-footer text-xs text-tertiary mt-xs">Manage order flow</div>
                    </div>
                </div>
            ...
            <div className="dashboard-section mb-xl">
                <div className="card stock-graph-container">
                    ...
                    <div className="graph-content h-[350px] w-full mt-xl">
                        <ResponsiveContainer width="100%" height={350}>
                            <BarChart data={prepareChartData()}>
                                ...
                                <Bar dataKey="current" radius={[4, 4, 0, 0]} barSize={50}>
